...
const all: CommandRoute[] = [balanceCommand, profileCommand, shopCommand, bonusCommand, gamesCommand, shopSettingsCommand, rightsCommand, grantCommand, revokeCommand];
